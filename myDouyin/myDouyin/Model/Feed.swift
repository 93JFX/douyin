...
struct AwemeListAuthor: Codable {
    ...
    let avatarLarger, avatarThumb, avatarMedium: ArakGroundhog?
    let birthday: String?
    let isVerified: Bool?
    ...
    let avatar168X168, avatar300X300: ArakGroundhog?
...
extension AwemeListAuthor {
    ...
    func with(
        ...
        avatarLarger: ArakGroundhog?? = nil,
        avatarThumb: ArakGroundhog?? = nil,
        avatarMedium: ArakGroundhog?? = nil,
        birthday: String?? = nil,
        isVerified: Bool?? = nil,
        ...
        avatar168X168: ArakGroundhog?? = nil,
        avatar300X300: ArakGroundhog?? = nil,
...
// MARK: ArakGroundhog convenience initializers and mutators

extension ArakGroundhog {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(ArakGroundhog.self, from: data)
    }
...
struct AuthorShareInfo: Codable {
    ...
    let shareQrcodeURL: ArakGroundhog?
...
extension AuthorShareInfo {
    ...
    func with(
        ...
        shareQrcodeURL: ArakGroundhog?? = nil,
...
struct Music: Codable {
    ...
    let coverHD, coverLarge, coverMedium, coverThumb: ArakGroundhog?
    let playURL: ArakGroundhog?
...
extension Music {
    ...
    func with(
        ...
        author: String?? = nil,
        album: String?? = nil,
        coverHD: ArakGroundhog?? = nil,
        coverLarge: ArakGroundhog?? = nil,
        coverMedium: ArakGroundhog?? = nil,
        coverThumb: ArakGroundhog?? = nil,
        playURL: ArakGroundhog?? = nil,
        ...
        preventDownload: Bool?? = nil,
        strongBeatURL: ArakGroundhog?? = nil,
        ...
        avatarThumb: ArakGroundhog?? = nil,
        avatarMedium: ArakGroundhog?? = nil,
        avatarLarge: ArakGroundhog?? = nil,
        previewStartTime: Int?? = nil,
        previewEndTime: Int?? = nil,
        effectsData: ArakGroundhog?? = nil,
        audioTrack: ArakGroundhog?? = nil
        ) -> Music {
        return Music(
            id: id ?? self.id,
...
struct PoiInfo: Codable {
    ...
    let expandType: Int?
    let iconOnMap, iconOnEntry, iconOnInfo: ArakGroundhog?
...
extension PoiInfo {
    ...
    func with(
        ...
        expandType: Int?? = nil,
        iconOnMap: ArakGroundhog?? = nil,
        iconOnEntry: ArakGroundhog?? = nil,
        iconOnInfo: ArakGroundhog?? = nil,
        showType: Int?? = nil,
...
struct Video: Codable {
    let playAddr, cover: ArakGroundhog?
    let height, width: Int?
    let dynamicCover, originCover: ArakGroundhog?
    let ratio: String?
    let downloadAddr: ArakGroundhog?
    let hasWatermark: Bool?
    let playAddrLowbr: ArakGroundhog?
    let bitRate: [BitRate]?
    let duration: Int?
    let downloadSuffixLogoAddr: ArakGroundhog?
...
extension Video {
    ...
    func with(
        playAddr: ArakGroundhog?? = nil,
        cover: ArakGroundhog?? = nil,
        height: Int?? = nil,
        width: Int?? = nil,
        dynamicCover: ArakGroundhog?? = nil,
        originCover: ArakGroundhog?? = nil,
        ratio: String?? = nil,
        downloadAddr: ArakGroundhog?? = nil,
        hasWatermark: Bool?? = nil,
        playAddrLowbr: ArakGroundhog?? = nil,
        bitRate: [BitRate]?? = nil,
        duration: Int?? = nil,
        downloadSuffixLogoAddr: ArakGroundhog?? = nil,
